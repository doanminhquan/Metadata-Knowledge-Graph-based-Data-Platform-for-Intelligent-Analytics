...
consumer.subscribe(['dbserver1.school.enrollment']) 

from pyspark.sql.types import *

enrollment_payload_schema = StructType([
...
full_schema = StructType([
    ...
    StructField("payload", enrollment_payload_schema, True)
])
    ...
    while True:
        ...
        try:
            if msg.value():
                ...
                write_raw_bucket(data=json_data, bucket="raw_bucket", status="unprocessed", database="school", table="enrollment", schema=full_schema)
