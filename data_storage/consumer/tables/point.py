...
consumer.subscribe(['dbserver1.school.point']) 

point_payload_schema = StructType([
    StructField("before", StructType([
        ...
        StructField("point_4", StringType(), True),  
        StructField("point_10", StringType(), True),
    ]), True),
...
full_schema = StructType([
    ...
    StructField("payload", point_payload_schema, True)
])
    ...
    while True:
        ...
        try:
            if msg.value():
                ...
                write_raw_bucket(data=json_data, bucket="raw_bucket", status="unprocessed", database="school", table="point", schema=full_schema)
