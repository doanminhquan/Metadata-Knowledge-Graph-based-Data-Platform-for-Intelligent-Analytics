...
consumer.subscribe(['dbserver1.school.program_course'])  

program_course_payload_schema = StructType([
...
full_schema = StructType([
    ...
    StructField("payload", program_course_payload_schema, True)
])
    ...
    while True:
        ...
        try:
            if msg.value():
                ...
                write_raw_bucket(data=json_data, bucket="raw_bucket", status="unprocessed", database="school", table="program_course", schema=full_schema)
