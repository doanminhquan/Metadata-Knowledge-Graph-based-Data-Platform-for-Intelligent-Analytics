...
consumer.subscribe(['dbserver1.school.graduate'])  

graduate_payload_schema = StructType([
    StructField("before", StructType([
        ...
        StructField("avg_score", StringType(), True),
    ]), True),
...
full_schema = StructType([
    ...
    StructField("payload", graduate_payload_schema, True)
])
    ...
    while True:
        ...
        try:
            if msg.value():
                ...
                write_raw_bucket(data=json_data, bucket="raw_bucket", status="unprocessed", database="school", table="graduate", schema=full_schema)
