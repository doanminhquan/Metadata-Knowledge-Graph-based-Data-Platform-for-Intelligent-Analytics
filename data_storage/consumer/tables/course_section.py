...
consumer.subscribe(['dbserver1.school.course_section']) 

course_section_payload_schema = StructType([
...
full_schema = StructType([
    ...
    StructField("payload", course_section_payload_schema, True)
])
    ...
    while True:
        ...
        try:
            if msg.value():
                ...
                write_raw_bucket(data=json_data, bucket="raw_bucket", status="unprocessed", database="school", table="course_section", schema=full_schema)
