...
consumer.subscribe(['dbserver1.school.course_group']) 

course_group_payload_schema = StructType([
...
full_schema = StructType([
    ...
    StructField("payload", course_group_payload_schema, True)
])
    ...
    while True:
        ...
        try:
            if msg.value():
                ...
                write_raw_bucket(data=json_data, bucket="raw_bucket", status="unprocessed", database="school", table="course_group", schema=full_schema)
