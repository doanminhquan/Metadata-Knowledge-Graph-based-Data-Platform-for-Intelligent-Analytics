...
consumer.subscribe(['dbserver1.school.term']) 

term_payload_schema = StructType([
...
full_schema = StructType([
    ...
    StructField("payload", term_payload_schema, True)
])
    ...
    while True:
        ...
        try:
            if msg.value():
                ...
                write_raw_bucket(data=json_data, bucket="raw_bucket", status="unprocessed", database="school", table="term", schema=full_schema)
