...
consumer.subscribe(['dbserver1.school.staff']) 

staff_payload_schema = StructType([
...
full_schema = StructType([
    ...
    StructField("payload", staff_payload_schema, True)
])
    ...
    while True:
        ...
        try:
            if msg.value():
                ...
                write_raw_bucket(data=json_data, bucket="raw_bucket", status="unprocessed", database="school", table="staff", schema=full_schema)
